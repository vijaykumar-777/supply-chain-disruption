        ...
        <div className="lg:col-span-2 glass rounded-xl relative overflow-hidden min-h-[500px]">
          ...
          <div className="absolute top-1/3 left-1/2 -translate-x-1/2 z-20 glass-elevated p-4 rounded-xl border border-primary/30 w-56 shadow-2xl">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-xs"><span className="text-on-surface-variant">Source:</span><span className={cn("font-bold", isNeo4jLive ? "text-success" : "text-tertiary")}>{isNeo4jLive ? "Neo4j Live" : "Unavailable"}</span></div>
            </div>
        ...
        <div className="glass rounded-xl flex flex-col h-full max-h-[500px]">
          <div className="p-4 border-b border-white/5 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] text-primary bg-primary/10 px-2 py-1 rounded font-bold uppercase tracking-widest">REAL-TIME</span>
        ...
        <div className="lg:col-span-3 glass rounded-xl p-6">
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-xs text-on-surface-variant">Daily count of live disruptions captured from the current event feed</p>
            </div>
          ...
          <div className="h-48 w-full">
            {liveEventTrend.some((entry) => entry.value > 0) ? (
              ...
              <div className="flex h-full items-center justify-center rounded-xl border border-dashed border-white/10 text-sm text-on-surface-variant">
                No live disruption history available yet.
              </div>
            )}
          </div>
        </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-on-surface-variant leading-relaxed">
              {events.length > 0
                ...
                : "No live disruptions are currently available. Connect Neo4j and live event ingestion to enable AI route analysis."}
            </p>
          </div>
